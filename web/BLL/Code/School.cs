...
namespace Tc.BLL
{
	...
	/// School
	/// </summary>
    public partial class School : BLLBase<School>
	{
		private readonly Tc.DAL.School dal=new Tc.DAL.School();
		public School()
		{}
		#region  BasicMethod
		/// <summary>
		...
		/// 获得数据列表
		/// </summary>
		public List<Tc.Model.School> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Tc.Model.School> DataTableToList(DataTable dt)
		{
			List<Tc.Model.School> modelList = new List<Tc.Model.School>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Tc.Model.School model;
