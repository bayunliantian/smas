...
namespace Tc.BLL
{
    ...
    public partial class Right2User : BLLBase<Right2User>
	{
		...
		/// 获得数据列表
		/// </summary>
		public List<Tc.Model.Right2User> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Tc.Model.Right2User> DataTableToList(DataTable dt)
		{
			List<Tc.Model.Right2User> modelList = new List<Tc.Model.Right2User>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Tc.Model.Right2User model;
